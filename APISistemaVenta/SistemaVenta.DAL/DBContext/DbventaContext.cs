...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuditoriaId).HasName("PK__Auditori__ED6C0FDB249C76DE");
            ...
            entity.Property(e => e.DetalleAccion)
                .HasColumnType("text")
                .HasColumnName("detalleAccion");
        ...
        {
            entity.HasKey(e => e.IdProveedor).HasName("PK__Proveedo__A3FA8E6B2629C448");
